    ...
    'COMPONENT': {
        ...
        'physics': {
            'rigidbody': {
                ...
                'sync_position': 'Luôn đồng bộ Position(toạ độ) của Rigidbody này trong hàm `update` của chính nó.',
				'sync_rotation': 'Luôn đồng bộ Rotation(góc) của Rigidbody này trong hàm `update` của chính nó.',
            },
            'physics_collider': {
                'density': 'The density',
